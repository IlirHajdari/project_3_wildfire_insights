...
function updateCharts(selectedYear, fireData) {
  let filteredData =
    selectedYear === "all"
      ? fireData
      : fireData.filter((d) => d.year == selectedYear);
  ...
  document.getElementById("ytdFireCount").innerText =
    ytdFireCount.toLocaleString();
  document.getElementById("ytdFireSize").innerText =
    fireSizeInMillions + " Million Acres";
}
